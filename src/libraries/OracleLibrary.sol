...
import "./FullMath.sol";
import "./TickMath.sol";
import "src/interfaces/external/IUniswapV3Pool.sol";
...
library OracleLibrary {
        ...
        returns (int24 arithmeticMeanTick, uint128 harmonicMeanLiquidity)
    {
        ...
        // @TODO: verify the int32 cast is safe
        // try number of seconds greater than int32 max
        ...
        returns (int24, uint128)
    {
        ...
        uint256 prevIndex = (
            uint256(observationIndex) + observationCardinality - 1
    ...
    function getWeightedArithmeticMeanTick(
        ...
        for (uint256 i; i < weightedTickData.length; i++) {
            // @TODO: verify the uint256 cast is safe
            numerator += weightedTickData[i].tick
